...
], BasketController.prototype, "getAllProducts", null);
__decorate([
    common_1.UseGuards(jwt_auth_guard_1.JwtAuthGuard),
    common_1.Post(),
    __param(0, common_1.Body()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [shopping_basket_entity_1.shoppingBasket]),
    __metadata("design:returntype", Promise)
], BasketController.prototype, "addProduct", null);
__decorate([
    common_1.UseGuards(jwt_auth_guard_1.JwtAuthGuard),
    common_1.Delete(":basket_id"),
    __param(0, common_1.Param("basket_id")),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], BasketController.prototype, "removeProduct", null);
BasketController = __decorate([
    common_1.Controller("basket"),
